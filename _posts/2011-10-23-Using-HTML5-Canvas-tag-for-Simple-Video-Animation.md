...
same as the CSS width and height attributes. This fact had me stumped for a while until I found this post on StackOverflow. The 
important take away for me was that I should set the canvas tag’s width and height to the size I want the canvas, and I could 
